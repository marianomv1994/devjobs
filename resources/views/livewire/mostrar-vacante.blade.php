<div class="p-10">
    <div class="mb-5">
        ...
        <div class="md:grid md:grid-cols-2 bg-gray-50 p-4 my-10">
            ...
            <p class=" font-bold  text-sm uppercase text-gray-800 my-3">
                Ultimo dia para postularse: <span class="normal-case font-normal">{{$vacante->ultimo_dia}}</span>
            </p>
    ...
    <div class="md:grid md:grid-cols-6 gap-4">
        <div class="md:col-span-2">
            <img src="{{asset('storage/vacantes/livewire-tmp/public/vacantes/'. $vacante->imagen)}}" alt="{{'Imagen vacante' . $vacante->titulo}}">
        </div>
