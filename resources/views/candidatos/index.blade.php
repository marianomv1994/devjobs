                            ...
                            @forelse ($vacante->candidatos as $candidato)
                                <li class="p-3 flex items-center">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xl text-gray-600">{{$candidato->user->email}}</p>
                                    ...
                                    <div>
                                        <a class="inline-flex items-center shadow-sm px-2.5 
                                        py-0.5 border border-gray-300 text-sm leading-5 
                                        font-medium rounded-full text-gray-700 bg-white
                                        hover:bg-gray-50"
                                         href="{{ asset( 'storage/vacantes/livewire-tmp/public/cv/' . $candidato->cv ) }}" target="_blank" rel="noreferrer noopener" >
                                            Ver cv
                                        </a>
